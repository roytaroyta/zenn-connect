...
### [Circleback](https://marketplace.visualstudio.com/items?itemName=circleback.circleback)
会議やタスクのメモを効率的に管理できる拡張機能です。
- VSCode上でTODOや議事録を整理
- チームでの情報共有が容易
- タスク管理の効率化

### [Cloud Run](https://marketplace.visualstudio.com/items?itemName=GoogleCloudTools.cloudcode)
Google Cloud Runのデプロイや管理を支援する拡張機能です。
- Cloud Runサービスのデプロイ・管理がVSCodeから可能
- ログの確認やデバッグもサポート
- クラウド開発の効率化

### [HTML View](https://marketplace.visualstudio.com/items?itemName=hdg.live-html-previewer)
