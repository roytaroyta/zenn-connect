...
| [TOML](https://toml.io/) | 設定ファイル向けのシンプルなマークアップ言語 |
| [RSS](https://validator.w3.org/feed/docs/rss2.html) | Webサイトのフィード配信用のXMLベースのフォーマット |
...
| [Visual Studio Code](https://azure.microsoft.com/ja-jp/products/visual-studio-code) | 汎用 | 軽量で拡張性に優れたコードエディタ |
| [Pycharm](https://www.jetbrains.com/ja-jp/pycharm/) | Python | Python開発に特化したIDE |
| [IntelliJ IDEA](https://www.jetbrains.com/idea/) | Java/汎用 | JetBrains製の高機能IDE |
...
| [Vercel](https://vercel.com/) | フロントエンド向けのCI/CD統合プラットフォーム |
